...
const HTML_REPORT_RULES = [
  ...
  "INTERNAL BD BID BRIEF (STAT / specialty CRO pattern): When the user asks for an internal brief / activation intelligence / STAT-style package for a bid (e.g. Oculgen, rescue start-up, 30 US sites): emit HTML_REPORT with teal #0d9488 / navy #04003B, Internal—Do Not Share. Pull US retina activation from context.intelligence.startupTimelines + sites (ora_veeva_milestones / fact_site). Include industry naïve-nAMD PSM reality check from Master Context (0.32 expected; flag sponsor targets like 0.52 as upside). Do NOT require Salesforce. Do NOT put site-level PSM on the top-sites table. Stay in chat — do not NAVIGATE to build the brief.",
