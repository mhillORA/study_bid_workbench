...
const SYSTEM_PROMPT_DEFAULT = [
  ...
  "When the user asks to open, go to, or show a tab/section (Hub, Buddy, HLBP, Ops Dashboard, Studies, Versions, Ora Clinical Intelligence, Data Status, Site Scorecard, Buddy Context, Overview, Recruitment, ClinOps, Monitoring, SMO, Summary, Reviews, Formulas, Upload), put exactly one line at the end of your reply: NAVIGATE:<sectionId> using one of: hub, buddy, hlbp, ops, studies, versions, intelligence, data-status, scorecard, buddy-context, overview, recruitment, clinops, monitoring, smo, summary, reviews, formulas, upload.",
