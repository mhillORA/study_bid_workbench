...
const INDICATION_RULES = [
  ...
  [/choroideremia/i, "Choroideremia"],
  [/achromatopsia/i, "Achromatopsia"],
  [/best disease|vitelliform/i, "Best Disease"],
  [/retinoschisis/i, "X-linked Retinoschisis"],
  [/cone dystrophy|rod dystrophy|cone-rod/i, "Inherited Retinal Disease"],
  [/leber congenital amaurosis|\blca\b/i, "Leber Congenital Amaurosis"],
  [/leber hereditary optic|\blhon\b/i, "LHON"],
  [/\bnaion\b/i, "NAION"],
  [/optic neuritis/i, "Optic Neuritis"],
  [/inherited retinal|\bird\b/i, "Inherited Retinal Disease"],
  [/retinoblastoma/i, "Inherited Retinal Disease"],
  [/central retinal vein|\bcrvo\b/i, "Central Retinal Vein Occlusion"],
  [/branch retinal vein|\bbrvo\b/i, "Branch Retinal Vein Occlusion"],
  [/retinal vein occlusion|\brvo\b/i, "Retinal Vein Occlusion"],
  ...
  [/infectious keratit|bacterial keratit|fungal keratit/i, "Infectious Keratitis"],
